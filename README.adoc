...
image:https://github.com/codeready-toolchain/registration-service/actions/workflows/workflow.yml/badge.svg[Operator CD,link="https://github.com/codeready-toolchain/registration-service/actions/workflows/workflow.yml"]
