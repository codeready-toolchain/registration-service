...
func (s *Usernames) GetHandler(ctx echo.Context) error {
	...
	if err != nil {
		...
		return crterrors.AbortWithError(ctx, http.StatusInternalServerError, err, "error getting MasterUserRecord resource")
	}
	...
	return ctx.JSON(http.StatusOK, username.Response{
