...
// func (s *TestProxySuite) TestHandleSpaceListRequest() {
// 	tests := map[string]struct {
...
// 			path:              "/api/namespaces",
// 			expectedWorkspace: "",
// 			expectedPath:      "/api/namespaces",
// 			expectedErr:       "",
// 		},
// 		"invalid space list request": {
// 			path:              "/api/namespaces/myworkspace",
// 			expectedWorkspace: "",
// 			expectedPath:      "/api/namespaces/myworkspace",
// 			expectedErr:       "",
// 		},
// 		"no space list request": {
// 			path:              "/api/pods",
// 			expectedWorkspace: "",
// 			expectedPath:      "/api/pods",
// 			expectedErr:       "",
...
// 			// then
// 			err := p.handleSpaceListRequest(ctx)
// 			if tc.expectedErr == "" {
// 				require.NoError(s.T(), err)
// 			} else {
// 				require.EqualError(s.T(), err, tc.expectedErr)
// 			}
// 			assert.Equal(s.T(), tc.expectedResponse, response)
// 		})
// 	}
// }
