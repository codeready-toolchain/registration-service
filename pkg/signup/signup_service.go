...
func (s *ServiceImpl) CreateUserSignup(ctx *gin.Context) (*v1alpha1.UserSignup, error) {
	...
	bannedUsers, err := s.BannedUsers.ListByHashedLabel(userEmail, v1alpha1.BannedUserEmailHashLabelKey)
	if err != nil {
		return nil, err
	}
...
func (s *ServiceImpl) PhoneNumberAlreadyInUse(userID, countryCode, phoneNumber string) error {
	bannedUserList, err := s.BannedUsers.ListByHashedLabel(countryCode+phoneNumber, v1alpha1.BannedUserPhoneNumberHashLabelKey)
	if err != nil {
	...
	userSignupList, err := s.UserSignups.ListByHashedLabel(countryCode+phoneNumber, v1alpha1.UserSignupUserPhoneHashLabelKey)
	if err != nil {
