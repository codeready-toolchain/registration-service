...
type FakeMasterUserRecordClient struct {
	...
	MockDelete func(ctx *gin.Context, name string, options *v1.DeleteOptions) error
}
...
func (c *FakeMasterUserRecordClient) Delete(ctx *gin.Context, name string, options *v1.DeleteOptions) error {
	if c.MockDelete != nil {
		return c.MockDelete(ctx, name, options)
	}
